...
// Own server baked in at build time: UK_SERVER=host UK_KEY=<id_ed25519.pub>.
pub const RENDEZVOUS_SERVERS: &[&str] = &[match option_env!("UK_SERVER") {
    Some(s) if !s.is_empty() => s,
    _ => "rs-ny.rustdesk.com",
}];
pub const RS_PUB_KEY: &str = match option_env!("UK_KEY") {
